        ...
        {education.map(
          ({
            ...
            >
              ...
              <div
                className="flex w-4/5 flex-col justify-center rounded-xl bg-accent/20 dark:bg-darkAccent/20
              ...
              >
                ...
                {today.isAfter(formattedDate(finalDate)) ? (
                  <p className="absolute top-3 right-12 rounded-xl bg-accent/60 dark:bg-darkAccent/60 py-1 px-3 text-xs lg:right-3">
                    Concluído!
                  </p>
                ) : (
                  <p className="absolute top-3 right-12 rounded-xl bg-accent/60 dark:bg-darkAccent/60 py-1 px-3 text-xs lg:right-3">
                ...
                <h4 className="text-sm font-medium text-darkerAccent dark:text-lighterAccent">
                  {course}
                </h4>
